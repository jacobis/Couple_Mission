...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mission_mission_category', (
        ...
        # Adding model 'UserMission'
        db.create_table('user_mission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'mission', ['UserMission'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserMission'
        db.delete_table('user_mission')
    ...
    models = {
        ...
        u'mission.missioncategory': {
            'Meta': {'object_name': 'MissionCategory', 'db_table': "'mission_mission_category'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mission.usermission': {
            'Meta': {'ordering': "['-updated_at']", 'object_name': 'UserMission', 'db_table': "'user_mission'"},
