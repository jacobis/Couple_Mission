...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoupleMission.started_datetime'
        db.add_column('couple_mission', 'started_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CoupleMission.claered_datetime'
        db.add_column('couple_mission', 'claered_datetime',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoupleMission.started_datetime'
        db.delete_column('couple_mission', 'started_datetime')

        # Deleting field 'CoupleMission.claered_datetime'
        db.delete_column('couple_mission', 'claered_datetime')
