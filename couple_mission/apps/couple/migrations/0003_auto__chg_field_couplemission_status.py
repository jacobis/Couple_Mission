...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CoupleMission.status'
        db.alter_column('couple_mission', 'status', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'CoupleMission.status'
        db.alter_column('couple_mission', 'status', self.gf('django.db.models.fields.BooleanField')())
