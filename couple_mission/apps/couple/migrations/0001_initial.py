...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('couple', (
            ...
            ('male', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='male_from', null=True, to=orm['account.UaiUser'])),
            ('female', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='female_from', null=True, to=orm['account.UaiUser'])),
        ))
