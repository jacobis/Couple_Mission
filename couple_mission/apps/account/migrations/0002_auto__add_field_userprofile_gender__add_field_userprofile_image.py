...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_user_profile', 'gender',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.image'
        db.add_column('account_user_profile', 'image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('account_user_profile', 'gender')

        # Deleting field 'UserProfile.image'
        db.delete_column('account_user_profile', 'image')
