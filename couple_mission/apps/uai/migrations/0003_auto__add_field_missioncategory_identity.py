...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MissionCategory.identity'
        db.add_column('uai_mission_category', 'identity',
                      self.gf('django.db.models.fields.CharField')(default='DM', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MissionCategory.identity'
        db.delete_column('uai_mission_category', 'identity')
