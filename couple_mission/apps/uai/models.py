...
class Mission(models.Model):
    ...
    image = models.ImageField("Image", upload_to='mission/', storage=getfilesystem(), blank=True, null=True)
...
class Badge(models.Model):
    name = models.CharField("Name", max_length=100)
    description = models.TextField("Description", default="", blank=True, null=True)
    image = models.ImageField("Image", upload_to='badge/', storage=getfilesystem(), blank=True, null=True)
