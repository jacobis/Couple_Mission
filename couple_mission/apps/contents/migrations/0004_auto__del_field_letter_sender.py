...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'contents_letter', 'sender_id')


    def backwards(self, orm):
        # Adding field 'Letter.sender'
        db.add_column(u'contents_letter', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
