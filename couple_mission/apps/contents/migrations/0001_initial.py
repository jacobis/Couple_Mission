...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contents_letter', (
            ...
            ('couple', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['couple.Couple'])),
            ('comment_manager', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['contents.CommentManager'], unique=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='recieved', null=True, to=orm['auth.User'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('already_read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('paper_type', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        ...
        u'contents.letter': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paper_type': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
