...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Letter.reading'
        db.delete_column(u'contents_letter', 'reading')

        # Adding field 'Letter.already_read'
        db.add_column('contents_letter', 'already_read',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Photo.comment'
        db.delete_column(u'contents_photo', 'comment_id')


    def backwards(self, orm):
        # Adding field 'Letter.reading'
        db.add_column(u'contents_letter', 'reading',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Letter.already_read'
        db.delete_column('contents_letter', 'already_read')

        # Adding field 'Photo.comment'
        db.add_column(u'contents_photo', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contents.Comment'], null=True, blank=True),
                      keep_default=False)
